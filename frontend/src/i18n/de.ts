...
export const de: Translations = {
  ...
  destinations: {
    ...
    httpInfoLabel: "Warum HTTP nicht empfohlen wird",
    httpInfo: "HTTP sendet Zugangsdaten und Ereignisse unverschlüsselt. HTTPS wird empfohlen. Hosts mit der Endung .internal, localhost, 127.0.0.1 und IPv6-Loopback ::1 sind erlaubt, HTTP benötigt aber weiterhin eine explizite Freigabe. In Docker verweist Loopback auf den App-Container; host.docker.internal erreicht den Docker-Host.",
    transport: "Transportsicherheit",
    requireHttps: "HTTPS erforderlich",
    allowHttp: "HTTP erlauben (nur Labor)",
    inheritTransport: "Deployment-Standard verwenden (bisheriges Verhalten)",
    httpWarning: "HTTP sendet Zugangsdaten und Ereignisse unverschlüsselt. Nur für ein vertrauenswürdiges Laborziel ohne TLS erlauben.",
    inheritHint: "Verwendet ALLOW_INSECURE_DESTINATION_URL des zustellenden Containers. Eine explizite Auswahl sorgt für einheitliches Verhalten.",
    httpLabel: "HTTP · unverschlüsselt",
    url: "URL",
    urlHintSplunk:
  ...
  applications: {
    ...
    emptyStates: {
      noConnection: "Noch keine MDM-Verbindung. Legen Sie eine unter Einstellungen › Verbindungen an und starten Sie eine Synchronisierung.",
      noSync: "Noch keine Synchronisierung abgeschlossen. Anwendungen erscheinen nach dem ersten Durchlauf.",
      synced: "Die letzte Synchronisierung hat auf keinem Gerät Anwendungen gemeldet.",
      noMatch: "Keine Anwendung passt zu dieser Suche."
    } as Record<string, string>,
    total: (n: number) => `${n} Anwendung${n === 1 ? "" : "en"} insgesamt`,
    record: {
      back: "Alle Anwendungen",
      loading: "Anwendung wird geladen…",
      notFound: "Keine Anwendung hat diesen Schlüssel.",
      errorLoading: "Diese Anwendung konnte nicht geladen werden.",
      copy: "Kopieren",
      copied: "Kopiert",
      lookupKey: "Suchschlüssel",
      lookupKeyHint: "md5 aus Name und Bundle-ID: die Adresse des Datensatzes, keine Identität, die Jamf kennt.",
      answer: (builds: number, installs: number, patchable: number, lastReported: string) =>
        `${builds} Build${builds === 1 ? "" : "s"} · ${installs} Installation${installs === 1 ? "" : "en"} · ${patchable} mit verfügbarem Patch · zuletzt gemeldet ${lastReported}`,
      answerNone: "Kein Gerät meldet diese App derzeit.",
      allCarriers: "jedes Gerät, auf dem sie läuft",
      spreadHeading: "Versionsverteilung",
      colVersion: "Version",
      colDevices: "Geräte",
      colPatch: "Jamf Patch",
      colLatest: "Aktuell",
      colVuln: "Schwachstellen",
      colFirstSeen: "Zuerst gesehen",
      colLastSeen: "Zuletzt gesehen",
      colJudged: "Beurteilt",
      colCarriers: "Träger",
      colTitle: "Jamf-Titel",
      colReleased: "Veröffentlicht",
      carriers: "→ Geräte",
      notJudged: "Noch nicht beurteilt",
      rememberedHeading: "Ihr Katalog erinnert sich an diese App; kein Gerät meldet sie derzeit",
      rememberedRow: (version: string, lastSeen: string) => `${version} · zuletzt gesehen ${lastSeen}`,
      unlistedHeading: "Jamf listet diese, niemand hier führt sie aus",
      unlistedNone: "Kein Jamf-Patch-Titel passt zu dieser App, also gibt es keine Jamf-Liste zum Vergleichen.",
      unlistedTitleLoading: "Jamfs Liste wird gelesen…",
      unlistedAllCarried: (titles: number) =>
        `Jede Version, die Jamf für ${titles === 1 ? "diesen Titel" : `diese ${titles} Titel`} listet, läuft irgendwo in der Flotte.`
    }
  },
  catalog: {
    tabLabel: "Katalog",
  ...
  vulnerabilities: {
    ...
    eyebrow: "Sicherheitslage",
    pageTitle: "Schwachstellen",
    pageDescription:
      "Jeder Build in der Flotte, zu dem der Korpus Funde hat – am stärksten exponiert zuerst: zunächst die auf der CISA-KEV-Liste, dann die auf den meisten Macs. Die Antwort gilt pro Build, nicht pro Mac: Jeder Mac mit diesem Build trägt dessen Funde.",
    searchPlaceholder: "Nach App-Name, Bundle-ID oder Version suchen",
    mostExposed: "Am stärksten exponiert",
    ...
    previous: "Zurück",
    next: "Weiter",
    noRows: "Kein Build in diesem Katalog passt zu diesem Filter.",
    exploreByApp: "Nach App erkunden",
    popularFilters: "Häufige Filter",
    ...
    numAppsAffected: "Builds mit Funden",
    ...
    lookupNvdNotice: "Dieses Produkt nutzt die NVD-API, wird von der NVD aber weder unterstützt noch zertifiziert. Der Link öffnet sich in Ihrem Browser; dieser Container ruft die NVD nie auf.",
  ...
  settings: {
    ...
    reEmitHelp: (devices: number, megabytes: number) =>
      `Sendet den aktuellen Inventar-Snapshot jedes Geräts dieser Verbindung, unabhängig von Änderungen — ${devices} Gerät${devices === 1 ? "" : "e"}, etwa ${megabytes} MB, vom Outbox-Takt dosiert. Für die Ereignisse, die ein Ausfall nach dem Löschen der Dead Letters verloren hat; den Rest deckt Redrive ab. Aus Jamf wird nichts gelesen.`,
    reEmitDestination: "Senden an",
  ...
  ai: {
    inventorySummary: {
      ...
      "preference": "Gewünschter Schwerpunkt / Ton",
      "placeholder": "Verschlechterte Verschlüsselung und neue kritische Befunde hervorheben.",
      "preferenceHelp": "/500 Zeichen. Die Vorgabe beeinflusst nur den Text; sie erlaubt keine Aktionen und ändert keine deterministischen Nachweise.",
      "pause": "Apple-FM-Pause zwischen Hintergrundaufrufen (Sekunden)",
      "save": "Inventareinstellungen speichern",
      "saving": "Wird gespeichert…",
      "saved": "Einstellungen für Inventar-Zusammenfassungen gespeichert.",
      "loadError": "Einstellungen für Inventar-Zusammenfassungen konnten nicht geladen werden.",
      "saveError": "Einstellungen konnten nicht gespeichert werden.",
      "metricsTitle": "Inventar-KI",
      "providerUnavailable": "Anbieter nicht verfügbar",
      "unavailable": "Zusammenfassungsmetriken nicht verfügbar. Vorherige Werte können veraltet sein.",
      "window": "Letzte 24 Stunden · Minutenzähler · Betriebsmesswerte, kein Kapazitätsbenchmark",
      "success": "Erfolgreiche Aufträge / Versuche",
      "dropped": "Verworfen oder fehlgeschlagen / empfangen",
      "overloads": "Antworten mit Ratenbegrenzung",
      "latency": "Mittlere Dauer des letzten Versuchs",
      "queued": "Wartend",
      "cached": "Cache-Treffer",
      "noUpdates": "Keine Änderungen",
      "attempts": "Versuche",
      "oldest": "Ältester wartender Auftrag",
      "none": "Keine",
      "asOf": "Stand",
      "diagnostics": "Ergebnisse mit Handlungsbedarf"
    },
    title: "KI",
    description:
