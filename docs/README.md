...
| --- | --- | --- |
| [`vulnerability-service-v2.md`](vulnerability-service-v2.md) | default-off preview; manual orphan cleanup (#621) | Contribute-or-pay access, retained tenant corpora, explicit submissions, ownership and release gates. |
