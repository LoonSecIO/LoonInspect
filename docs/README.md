...
| --- | --- | --- |
| [`vulnerability-service-v2.md`](vulnerability-service-v2.md) | scope agreed; implementation not started, 2026-09-20 | Contribute-or-pay access, retained tenant corpora, explicit submissions, ownership and release gates. |
