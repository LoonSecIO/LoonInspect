...
| --- | --- | --- |
| [`vulnerability-service-v2.md`](vulnerability-service-v2.md) | scope agreed; historical evidence in progress (#621) | Contribute-or-pay access, retained tenant corpora, explicit submissions, ownership and release gates. |
